...
module.exports = [{
  "name": "nolasco",
  "role": "Web Developer",
  "description": "Lorem ipsum dolor sit amet consectetur adipisicing elit. Id autem atque nam hic rerum iste impedit aut reprehenderit doloribus repudiandae eos quasi sunt, esse illo porro asperiores ut ea qui.",
  ...
  "description": "Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aliquam sunt consequatur id voluptatibus saepe sit consequuntur eligendi repellat, quos architecto corrupti velit, alias, aut nesciunt.",
  ...
  "name": "Bernas",
  "role": "Game Developer",
  "description": "Lorem ipsum dolor sit amet consectetur adipisicing elit. Doloribus, tempora qui. Officia optio illo fugit expedita incidunt excepturi repellat a necessitatibus, eius tenetur saepe cumque reiciendis assumenda delectus, Itaque repellat nisi tempore dolore.",
  ...
  "description": "Lorem ipsum dolor sit amet consectetur adipisicing elit. Sequi accusantium dolor doloribus repellat unde voluptatem possimus. Eaque, enim necessitatibus nostrum minima corrupti.",
  ...
  "name": "Fernandez",
  "role": "Desktop Developer",
  "description": "Lorem ipsum dolor sit amet consectetur adipisicing elit. Sequi accusantium dolor doloribus repellat unde voluptatem possimus. Eaque, enim necessitatibus nostrum minima corrupti, quo aperiam tempora.",
...
console.log(_data.default.length);
...
for (var i = 0; i < _data.default.length; i++) {
  ...
  att.value = _data.default[i].image;
  ...
  var name = document.createTextNode(_data.default[i].name);
  h1.append(name);
  details.appendChild(h1);
  var h3 = document.createElement('h3');
  name = document.createTextNode(_data.default[i].role);
  h3.append(name);
  details.appendChild(h3);
  var p = document.createElement('p');
  name = document.createTextNode(_data.default[i].description);
  p.append(name);
