...
var open = document.querySelectorAll('.fa-angle-double-left');
var slider = document.querySelectorAll('.swiper-details');
var index = 0;
...
document.addEventListener('click', function (e) {
  if (e.target.classList.contains('fa-angle-double-left')) {
    ...
    for (var _i = 0; _i < slider.length; _i++) {
      slider[_i].style.clipPath = 'circle(0% at 110% 50%)';
    }
  } else if (e.target.classList.contains('swiper')) {
    for (var _i2 = 0; _i2 < slider.length; _i2++) {
      slider[_i2].style.clipPath = 'circle(0% at 110% 50%)';
    }
  }
});
